...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: "Facebook",
      url: "https://www.facebook.com/savinjainindore",
      icon: (
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/savin_jain/",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/savin-jain-745342b3/",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor">
...
>
        ...
        <div className={`${styles.bottom} footer-reveal`}>
          <div className={styles.contact}>
            <a href="mailto:savin.jain@gmail.com" className={styles.contactItem}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                <polyline points="22,6 12,13 2,6"/>
              </svg>
              savin.jain@gmail.com
            </a>
            <a href="tel:+919826667279" className={styles.contactItem}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <a href="tel:+919575444470" className={styles.contactItem}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.362 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.574 2.81.7A2 2 0 0122 16.92z"/>
              </svg>
              +91 95754 44470
          ...
          <p className={styles.copyright}>&copy; 2025 Savin Jain. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
